...
In simpler terms, it accounts for the fact that:

-   A tract's vote share may be influenced by the vote share in **neighboring tracts**\
-   **Unobserved factors** that affect voting may also be **spatially clustered**
-   And each tract has its own stable, unchanging characteristics, plus all units are affected by **year-specific trends**
